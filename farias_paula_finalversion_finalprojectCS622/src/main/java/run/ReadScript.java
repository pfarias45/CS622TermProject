...
public abstract class ReadScript {
	...
	protected static String adminScript;
	protected static String adminScript2;
	protected static String adminScript3;
	...
	*/
	public static void readFile() {
		try {
			...
			adminScript = (String)askReader.get("AdminScript");
			adminScript2 = (String)askReader.get("AdminScript2");
			adminScript3 = (String)askReader.get("AdminScript3");
